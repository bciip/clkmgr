...
## MY_EDIT :begin (commented idle port after removing kmac & hmac)
##    { struct:  "logic",
##      type:    "uni",
##      name:    "idle",
##      act:     "rcv",
...
##      width:   "${len(hint_clks)}"
##    },
## MY_EDIT :end (commented idle port after removing kmac & hmac)
  ],
...
## MY_EDIT :begin (commented 2 regs(CLK_HINTS & CLK_HINTS_STATUS) after removing kmac & hmac)
##    { name: "CLK_HINTS",
##      desc: '''
...
##      ]
##    },
## MY_EDIT :end (commented 2 regs(CLK_HINTS & CLK_HINTS_STATUS) after removing kmac & hmac)
  ]
}
